    ...
    itemListElement: [
      {
        ...
        description:
          "Expert drywall repair services including hole patching, water damage repair, and crack fixing with seamless finishes.",
        provider: {
          "@type": "LocalBusiness",
          name: "WallMasters Drywall Vancouver",
        },
      ...
      },
      {
        ...
        description:
          "Professional drywall installation services for new construction, renovations, and custom projects.",
        provider: {
          "@type": "LocalBusiness",
          name: "WallMasters Drywall Vancouver",
        },
      ...
      },
      {
        ...
        description:
          "Specialized texture matching services for walls and ceilings, including popcorn, orange peel, and knockdown textures.",
        provider: {
          "@type": "LocalBusiness",
          name: "WallMasters Drywall Vancouver",
        },
      ...
      },
      {
        ...
        url: "https://drywallvan.ca/commercial-drywall",
        description:
          "Commercial drywall services for office build-outs, retail spaces, industrial facilities, and healthcare facilities.",
        provider: {
          "@type": "LocalBusiness",
          name: "WallMasters Drywall Vancouver",
        },
      ...
      <main>
        ...
        <section className="py-20 bg-black text-white">
          <div className="max-w-5xl mx-auto px-4 text-center">
            ...
            <button
              onClick={() => copyToClipboard("7789074485", true)}
            ...
            <div className="flex justify-center">
              <button
                onClick={() => copyToClipboard("info@drywallvan.ca", false)}
                className={`${
                  copiedEmail
